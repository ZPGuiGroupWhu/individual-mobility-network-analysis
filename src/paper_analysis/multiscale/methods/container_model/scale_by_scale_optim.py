...
class ScalesOptim:
    ...
    def __init__(self,
        ...
        pdist = general_pdist(self.stop_locations, distance_function=distance_func)
        # print(pdist)
    ...
    def _worker(self, inputs):
        ...
        (proba_dist, proba_dist_counts), _, _, alphas = compute_likelihood(source_target,
    ...
    def find_best_scale(self):
        ...
        (proba_dist_min, _), _, _, alphas_min = compute_likelihood(source_target,
                                                                                        return_all_values=True)
        ...
        while improvement:
            ...
            for candidate_series, n_params, LL, proba_dist, criterion, n, max_Rs, label_to_cell_map, alphas in result:
                ...
                if self.verbose:
                    ...
                    if self.information_criterion:
                        ...
                        print("| delta %s: %.01f" % (self.information_criterion, d_criterion))
                    else:
                        print("| delta L: %.01f" % d_criterion)
            ...
            if improvement:
                ...
                if self.siglvl is not None:
                    ...
                    if self.bootstrap:
                        pval, L_vec, L_prev_vec = bootstrap_pval(final_series, series, self.stat_test,
